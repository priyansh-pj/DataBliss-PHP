    ...
    <div class="col-xl-12 col-sm-12 mb-xl-12 mb-12">
        ...
        <div class="table-responsive">
            ...
            <thead>
                ...
                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"style="width:20%;">Sales Date</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="align-middle text-center" style="padding-top: 0px;">
                        <span class="text-secondary text-md font-weight-bold"><?=$data->sales_date?></span>
                    </td>
                    <td class="align-middle" >
                        <a href="<?= base_url("databliss/Billing/print_invoice/".$data->id); ?>" class="btn bg-gradient-info" >
                        Print
                        </a>
                    </td>
                    <td class="align-middle" >
                        
                        <a href="<?= base_url("databliss/Billing/invoice_delete/".$data->id); ?>" class="btn bg-gradient-danger" >
                        delete
                        </a>
                    </td>
                </tr>
